            ...
            <div className="card-body d-flex justify-content-center w-100">
              ...
              <div className="column pt-4 mt-0">
                <div className="mt-5" style={{ position: 'relative', top: '30px', right: '35px' }}>
                  <p className="text-danger title-red" style={{ position: 'relative', marginTop: '110px', left: '0px', }}>BENEFICIOS:</p>
                  ...
                  <p className="small text-muted text-normal" style={{ position: 'relative', top: '-5px', left: '0px', }}><strong className="text-danger mr-2">+</strong>Gel con delicioso sabor a tutti-frutti</p>
                  <p className="small text-muted text-normal" style={{ position: 'relative', top: '-5px', left: '0px', }}><strong className="text-danger mr-2">+</strong>Con flúor para niños</p>
